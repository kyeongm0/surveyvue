  ...
  actions: {
    LoginProcess({ commit }, payload) {
      ...
      return new Promise((resolve, reject) => {
          axios.post('http://13.124.33.26:9000/api/auth/signin', payload)
              .then(Response => {
    ...
    SignUp({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
          axios.post('http://13.124.33.26:9000/api/auth/signup', payload)
              .then(Response => {
                  console.log(Response.data)
    ...
    UserList({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
          axios.get('http://13.124.33.26:9000/api/test/user/'+payload)
              .then(Response => {
                  console.log(Response.data)
    ...
    UserDetail({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/userDetail', {
          params: {
            username: payload
          }
        })
    ...
    UserEdit({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/userEdit/'+payload.username)
            .then(Response => {
                console.log(Response.data)
    ...
    UserEditProcess({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/userEditProcess', payload)
            .then(Response => {
                console.log(Response.data)
    ...
    UserDelete({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.delete('http://13.124.33.26:9000/api/test/userDelete/'+payload.username)
            .then(Response => {
                console.log(Response.data)
                Route.push('/userList')
            })
    ...
    UserLevelChange({dispatch},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/userLevelChange', payload)
            .then(Response => {
                console.log(Response.data)
    ...
    console.log(payload)
    return new Promise((resolve, reject) => {
      axios.get('http://13.124.33.26:9000/api/test/board/'+payload)
          .then(Response => {
              console.log(Response.data)
    ...
    BoardDetail({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/boardDetail', {
          params: {
            bId: payload
          }
        })
    ...
    BoardEdit({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/boardEdit/'+payload.bId)
            .then(Response => {
                console.log(Response.data)
    ...
    BoardEditProcess({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/boardEditProcess', payload)
            .then(Response => {
                console.log(Response.data)
    ...
    BoardDelete({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.delete('http://13.124.33.26:9000/api/test/boardDelete/'+payload.bId)
            .then(Response => {
                console.log(Response.data)
    ...
    BoardWrite({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/boardWrite', payload)
            .then(Response => {
                console.log(Response.data)
    ...
    Upload({commit},payload) {    
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/upload', payload)
            .then(Response => {
                console.log(Response.data)
    ...
    UploadUpdate({commit},payload) {    
      ...
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/uploadUpdate', payload)
            .then(Response => {
                console.log(Response.data)
                Route.push('/boardlist')
            })
    ...
    BoardReplyProcess({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/boardReplyProcess', payload)
            .then(Response => {
                console.log(Response.data)
                if(Response.data === "success") {
                  Route.push('/boardlist')
    ...
    CommentList({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/comment/'+payload.checkId+'/'+payload.pageNum)
            .then(Response => {
                console.log(Response.data)
    ...
    CommentWrite({dispatch},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/commentWrite', payload)
            .then(Response => {
                console.log(Response.data)
    ...
    CommentReply({dispatch},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/commentReply', payload)
            .then(Response => {
                console.log(Response.data)
                dispatch( 'CommentList', {pageNum: Response.data.pagination.page, checkId: Response.data.bId} )
            })
    ...
    CommentEdit({dispatch},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/commentEdit', payload)
            .then(Response => {
                console.log(Response.data)
                dispatch( 'CommentList', {pageNum: Response.data.pagination.page, checkId: Response.data.bId} )
            })
    ...
    CommentDelete({dispatch},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.delete('http://13.124.33.26:9000/api/test/commentDelete/'+payload.cId)
            .then(Response => {
                console.log(Response.data)
    ...
    BoardSearch({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/boardSearch/'+payload.search+'/'+payload.keyword+'/'+payload.page)
            .then(Response => {
                console.log(Response.data)
    ...
    AddSurvey({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/addSurvey', payload)
            .then(Response => {
                console.log(Response.data)
                Route.push('/survey')
            })
    ...
    SurveyList({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/survey/'+payload)
            .then(Response => {
                console.log(Response.data)
    ...
    SurveyDetail({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/surveyDetail', {
          params: {
            sId: payload
          }
        })
    ...
    SurveyDelete({dispatch},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.delete('http://13.124.33.26:9000/api/test/surveyDelete/'+payload.sId)
            .then(Response => {
                console.log(Response.data)
    ...
    SurveyAnswer({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://13.124.33.26:9000/api/test/surveyAnswer', payload)
            .then(Response => {
                console.log(Response.data)
                if(Response.data === "success") {
                  Route.push('/survey')
    ...
    Analysis({commit}, payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/surveyReport', {
          params: {
            sId: payload
          }
        })
    ...
    AnswerDetail({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/answerDetail', {
          params: {
    ...
    QuestionChart({commit},payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/test/questionChart', {
          params: {
            qId: payload.qId,
            sId: payload.sId
          }
    ...
    admin({commit}) {
      ...
      console.log(token)
      return new Promise((resolve, reject) => {
        axios.get('http://13.124.33.26:9000/api/admin/adminPage')
            .then(Response => {
              console.log(Response.data)
    ...
    UnpackToken({commit}) {
      return new Promise((resolve, reject) => {
        ...
        axios.get('http://13.124.33.26:9000/api/auth/unpackToken')
            .then(Response => {
              console.log(Response.data)
