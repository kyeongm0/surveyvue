<template>
  ...
  import ReplyComment from '@/components/CommentEdit/ReplyComment.vue'
  import EditComment from '@/components/CommentEdit/EditComment.vue'
      ...
      computed: {
         ...
         fileLoad() {
          ...
          for(let i=0; i<this.board_detail.uploadList.length; i++) {
            ...
            upload.upload = 'http://13.124.33.26/img/' + this.board_detail.uploadList[i].upload
